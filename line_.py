...
image=cv2.imread('C:/Users/NISHANT/Desktop/projects_github/autoz/lane2.jpeg')
...
pts = np.array([[167,70],[140,120],[140,180],[167,220]], np.int32)
x=cv2.polylines(canny_edges,[pts],True,(0,0,0))
mask = np.array([pts], dtype=np.int32)
image2 = np.zeros((167,301), np.int8)
